# TESTING.md — ZineIt v5.1 test report

**Result: 216 passed · 0 failed · 0 console errors in the app suite, plus 22 Lua unit
tests for the Lightroom plug-in — 238 total, all green.** The whole tool — through the
