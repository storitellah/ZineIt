# TESTING.md — ZineIt v4.6 test report

**Result: 199 passed · 0 failed · 0 console errors in the app suite, plus 22 Lua unit
tests for the Lightroom plug-in — 221 total, all green.** The whole tool — through the
