# TESTING.md — Zineit by Storitellah v5.2 test report

**Result: 224 passed · 0 failed · 0 console errors in the app suite, plus 22 Lua unit
tests for the Lightroom plug-in — 246 total, all green.** The whole tool — through the
