# TESTING.md — ZineIt v5.0 test report

**Result: 210 passed · 0 failed · 0 console errors in the app suite, plus 22 Lua unit
tests for the Lightroom plug-in — 232 total, all green.** The whole tool — through the
