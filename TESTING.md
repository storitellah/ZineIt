...
**Result: 97 passed · 0 failed · 0 console errors in the app suite, plus 22 Lua unit
tests for the Lightroom plug-in — 119 total, all green.** The whole tool — including the
...
| Console health | Zero page errors or uncaught exceptions across all 97 app tests |
